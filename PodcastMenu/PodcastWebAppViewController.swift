...
//            touchBarController.showTouchBar()
    ...
    fileprivate func createConfigMenu() {
        ...
        activeEpisodesItem.state = Preferences.showActiveEpisodes ? NSControl.StateValue.on : NSControl.StateValue.off
    ...
    @objc fileprivate func toggleActiveEpisodes(_ sender: NSMenuItem) {
        sender.state = sender.state == NSControl.StateValue.on ? NSControl.StateValue.off : NSControl.StateValue.on
        Preferences.showActiveEpisodes = (sender.state == NSControl.StateValue.on)
